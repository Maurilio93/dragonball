...
export function ModificaPassword() {
    ...
    return (
        <section className="bg-gray-100 min-h-screen flex justify-center items-center" style={{
            backgroundImage: `url('src/images/wallpaperbetter.com_3840x2160.jpg')`,
            ...
            <div className="w-full max-w-md px-4 py-16 sm:px-6 lg:px-8">
                <div className="text-center mb-8">
                    <h1 className="text-2xl font-bold text-black">MODIFICA LA TUA PASSWORD!</h1>
                </div>
